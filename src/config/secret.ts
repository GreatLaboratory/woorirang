...
export const MYSQL_URI: string = process.env.MYSQL_URI;
...
export const AWS_ACCESSKEY_ID: string = process.env.AWS_ACCESSKEY_ID;
export const AWS_SECRET_ACCESSKEY: string = process.env.AWS_SECRET_ACCESSKEY;
